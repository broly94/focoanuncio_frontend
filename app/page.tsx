...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-emerald-600 to-teal-500 min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl font-extrabold text-white sm:text-5xl md:text-6xl">
            Encuentra la mejor estrategia de marketing
          </h1>
          ...
          <div className="mt-10">
            <Button size="lg" variant="default" className="bg-white text-emerald-600 hover:bg-gray-100 mr-4" asChild>
              <Link href="/register">Crear cuenta gratis</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-emerald-700/20" asChild>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Conecta con clientes potenciales y haz crecer tu negocio con nuestra plataforma especializada en
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-600">
                Conecta con usuarios interesados específicamente en tu sector y ubicación geográfica.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-600">
                Obtén estadísticas sobre el rendimiento de tu estrategia y conoce mejor a tu audiencia.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-emerald-600 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Únete a miles de empresas que ya están aprovechando FocoAnuncio para aumentar su visibilidad y conseguir más
            clientes.
          </p>
