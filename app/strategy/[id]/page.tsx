...
import { MapPin, Clock, Globe, Phone, Star, Share2, Heart } from "lucide-react"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 rounded-xl overflow-hidden mb-8">
        <img
          src="/placeholder.svg?height=400&width=1200&text=Banner+Image"
          alt="Strategy banner"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-700">
                            Excelente estrategia de marketing. Nos ayudó a aumentar nuestras ventas en un 30% en el
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm p-6 mb-6 sticky top-24">
            ...
            <Button className="w-full mb-3">Contactar</Button>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-3">
                <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-600 text-white">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-pink-600 text-white">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-sky-500 text-white">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-700 text-white">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-semibold mb-4">Estrategias similares</h3>
            <div className="space-y-4">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-start">
                  <div className="w-16 h-16 rounded-lg overflow-hidden bg-gray-200 mr-3 flex-shrink-0">
                    <img
                      src={`/placeholder.svg?height=64&width=64&text=S${i + 1}`}
                      alt={`Similar strategy ${i + 1}`}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div>
                    <h4 className="font-medium text-sm">Estrategia similar #{i + 1}</h4>
                    <div className="flex items-center mt-1 mb-1">
                      <Star className="w-3 h-3 text-yellow-400" fill="currentColor" />
                      <span className="text-xs text-gray-600 ml-1">4.{i + 5}</span>
                    </div>
                    <Link href={`/strategy/${i + 10}`} className="text-xs text-emerald-600 hover:underline">
                      Ver detalles
                    </Link>
                  </div>
                </div>
